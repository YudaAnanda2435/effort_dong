  ...
  return (
    <section className="products section" id="products">
      <div className="container">
        <div className="products-header pt-2! gap-5">
          <div className="product-info-text">
            <h2
              className="section-h2-product flex gap-2 items-center flex-row"
              data-aos="fade-right"
              data-aos-delay="100"
            >
              Produk{" "}
              <span className="highlight w-fit text-dark! font-semibold italic">
                Effort.Dong
              </span>
            </h2>
